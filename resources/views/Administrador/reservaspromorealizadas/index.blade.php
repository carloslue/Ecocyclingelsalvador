                ...
                <div class="card">
                    <div class="card-header bg-info">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="card_title">
                                {{ __('Reservas de promociones SERVICIOS TURISTICOS REALIZADOS') }}
                            </span>
                                ...
                                <tbody>
                                    @foreach ($reservaspromos as $reservaspromo)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('reservapromorealizada.destroy', $reservaspromo->id) }}"
                                                    method="POST">
                                                    <a class="btn btn-sm btn-success" href="{{ route('reservapromorealizada.edit',$reservaspromo->id) }}"><i class="fa fa-fw fa-edit"></i>Enviar a ventas</a>
